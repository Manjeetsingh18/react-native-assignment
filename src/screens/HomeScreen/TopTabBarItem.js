...
const styles = StyleSheet.create({
  ...
  imageViewStyle: {
    height: constants.responsiveHeight(10),
    width: constants.responsiveHeight(15),
    alignItems: 'center',
  },
  imageStyle: {
    height: '40%',
  ...
  datialsViewStyle: {
    marginBottom: 15,
    width: constants.deviceWidth - constants.responsiveHeight(15),
  },
  textStyle: {
    fontSize: 7.5,
    fontWeight: '400',
  },
  detailTextStyle: {fontSize: 13, fontWeight: '500'},
});
