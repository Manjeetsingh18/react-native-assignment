...
const PopularItems = props => {
  const {item, index, onPressPapularItem} = props;
  let Image_Http_URL = {
  ...
  return (
    <Pressable
      ...
      onPress={() => onPressPapularItem(item, index)}>
      <View style={styles.circleViewStyle}>
        <Image style={styles.imageStyle} source={Image_Http_URL} />
      </View>
...
const styles = StyleSheet.create({
  ...
  addTextStyle: {fontSize: 9, fontWeight: '400'},
});
